...
class CommandProcessor {
    constructor(options, entityId) {
        ...
        this.prepareContext = () => __awaiter(this, void 0, void 0, function* () {
            ...
            this.oldEntity = fast_copy_1.default(this.entity);
            this.oldState = fast_copy_1.default(this.state);
        });
        this.storeContext = () => __awaiter(this, void 0, void 0, function* () {
            if (!fast_equals_1.deepEqual(this.oldEntity, this.entity) ||
                !fast_equals_1.deepEqual(this.oldState, this.state)) {
                const tuple = {
                    entity: this.entity,
                    state: this.state
                };
        ...
        this.processCommand = (command) => __awaiter(this, void 0, void 0, function* () {
            ...
            const holder = new entity_1.EntityStateHolder(this.entity, this.state, decorateEntity);
            ...
            const handler = router_1.lookupHandler(routeHandlers[holder.state.name], command);
            if (!handler) {
